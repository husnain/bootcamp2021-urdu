...
let todos = [
    ...
    new todoItem_1.TodoItem(3, "Buy Books", true), new todoItem_1.TodoItem(4, "Read Books"),
    new todoItem_1.TodoItem(5, "do practicle"), new todoItem_1.TodoItem(6, "go to sleep", true),
    new todoItem_1.TodoItem(7, "Collect Tickets"), new todoItem_1.TodoItem(8, "Call Joe", true)
];
let collection = new jsonTodoCollection_1.JsonTodoCollection("Husnain", todos);
